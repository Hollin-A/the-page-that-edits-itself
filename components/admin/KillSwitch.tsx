...
export default function KillSwitch({ active }: { active: boolean }) {
  ...
  return (
    <div id="kill-switch" className="bg-white border border-neutral-200 rounded-xl px-6 py-5">
      <div className="flex items-start justify-between gap-6">
        <div>
          <h2 className="text-sm font-semibold text-neutral-900">Kill switch</h2>
        ...
        <button
          ...
          className={`shrink-0 relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none disabled:opacity-50 ${
            active ? 'bg-red-500' : 'bg-neutral-200'
          }`}
